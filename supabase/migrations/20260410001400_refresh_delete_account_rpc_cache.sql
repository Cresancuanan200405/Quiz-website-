-- Recreate delete-account RPC and force PostgREST schema cache refresh.
-- Use this when the API reports the function is missing from schema cache.
...
-- Refresh PostgREST schema cache so new/updated RPC appears immediately.
